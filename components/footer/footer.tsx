...
<div className="w-screen min-h-screen flex items-center justify-center bg-black">
        <div className="md:w-2/3 w-full px-4 text-white flex flex-col">
            <div className="w-full text-7xl md:sm font-bold">
                <h1 className="w-full md:w-2/3">La Ciudad Nunca Duerme, Nosotros Tampoco</h1>
            </div>
            <div className="flex mt-8 flex-col md:flex-row md:justify-between">
                <div className="w-full md:w-2/3 text-gray-400">Especialistas en Monitoreo de Alarmas <p className='w-full md:w-2/3 text-[#25c05a]'>las 24 Horas del Dia</p></div>
                <div className="w-44 pt-6 md:pt-0">
                    <a href='https://api.whatsapp.com/send?phone=%2B59162164030&data=ARBfu64otP6Rn2I9N-Oo4Gc_mTiBguQ0WqM5049gOnJJCvlmbgADAmKJRD-MITRaTTTivOCaluPFqKN14YI03MWvi0c0aW0RpAkRmHv1hfB35X_dzebnZ702eCNibGclG1-nG_jLoZsX5TictRZ3PMo&source=FB_Page&app=facebook&entry_point=page_cta&fbclid=IwAR2x8wQ4GAcxWLkwzrazbvm281lwMq45MOlQZWSTZYRt4yBujJw3M2b9Iu8' className="bg-[#25c05a] justify-center text-center rounded-lg shadow px-10 py-3 flex items-center">Contactanos</a>
                </div>
            </div>
            <div className="flex flex-col">
                <div className="flex mt-24 mb-12 flex-row justify-between">
                    <div className="">
                        <Image src='/assets/Logojpg.jpg' width={80} height={80} alt=''></Image>  
                    </div>
                    <a className="hidden md:block cursor-pointer text-gray-600 hover:text-white uppercase mt-5">Acerca De Nosotros</a>
                    <a className="hidden md:block cursor-pointer text-gray-600 hover:text-white uppercase mt-5">Servicios</a>
                    <a className="hidden md:block cursor-pointer text-gray-600 hover:text-white uppercase mt-5">Why us</a>
                    <a href='https://api.whatsapp.com/send?phone=%2B59162164030&data=ARBfu64otP6Rn2I9N-Oo4Gc_mTiBguQ0WqM5049gOnJJCvlmbgADAmKJRD-MITRaTTTivOCaluPFqKN14YI03MWvi0c0aW0RpAkRmHv1hfB35X_dzebnZ702eCNibGclG1-nG_jLoZsX5TictRZ3PMo&source=FB_Page&app=facebook&entry_point=page_cta&fbclid=IwAR2x8wQ4GAcxWLkwzrazbvm281lwMq45MOlQZWSTZYRt4yBujJw3M2b9Iu8' className=" mt-5 hidden md:block cursor-pointer text-gray-600 hover:text-white uppercase">Contactanos</a>
                    <div className="flex flex-row space-x-8 items-center justify-between">
                        <a href='https://www.facebook.com/profile.php?id=100093286224910'>
                ...
                <p className="w-full text-center my-12 text-gray-600">Copyright © 2024 Alarcruz S.R.L.  </p>
            </div>
        </div>
    </div>
  )
